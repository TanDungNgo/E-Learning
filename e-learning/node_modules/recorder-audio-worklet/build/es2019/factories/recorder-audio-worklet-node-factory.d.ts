...
export declare const createRecorderAudioWorkletNodeFactory: (createListener: typeof createListenerFunction, createPostMessage: ReturnType<typeof createPostMessageFactory>, on: typeof onFunction, validateState: typeof validateStateFunction) => <T extends TContext | TNativeContext>(audioWorkletNodeConstructor: T extends TContext ? TAudioWorkletNodeConstructor : {
    new (context: BaseAudioContext, name: string, options?: AudioWorkletNodeOptions | undefined): AudioWorkletNode;
    prototype: AudioWorkletNode;
}, context: T, options?: Partial<TAnyRecorderAudioWorkletNodeOptions<T>>) => T extends TContext ? IRecorderAudioWorkletNode<T> : INativeRecorderAudioWorkletNode;

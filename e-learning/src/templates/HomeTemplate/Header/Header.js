...
<nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
    <div className="px-4 flex flex-wrap justify-between items-center mx-auto">
      ...
      <div className="align-middle hidden w-full md:block md:w-auto" id="mobile-menu">
      ...
      {userLogin ? (
          ...
          <>
            ...
            <hr style={{height: "40px", width: "1px", backgroundColor: "gray"}} className="absolute"></hr>
              <button
              ...
              <button
                className="w-full col-span-1 bg-orange-100 hover:bg-orange-300 text-orange-700 font-semibold hover:text-white py-1 px-4 border border-2 border-orange-300 hover:border-transparent rounded"
                onClick={() => {

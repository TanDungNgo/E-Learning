...
class CreateCoure extends Component {
      ...
      >
        ...
        <Form
          ...
          >
            ...
            <Form.Item>
<button type="submit" class="text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2">
  Create
</button>
            </Form.Item>
          </Form>
